...
public class Facade {
	...
	public String listarCompras() {
		return controleCliente.ordenaTudo();
	}
	public void	ordenaPor(String criterio) {
		controleCliente.setCriterioOrdenacao(criterio);
	}
	

	public static void main(String[] args) {
		args = new String[] { "lab5.Facade", "testesEA/use_case_1.txt", "testesEA/use_case_2.txt",
				"testesEA/use_case_3.txt", "testesEA/use_case_4.txt", "testesEA/use_case_5.txt", "testesEA/use_case_6.txt", "testesEA/use_case_7.txt", "testesEA/use_case_8.txt"};
